// 测试1680-2180元预算范围的概率分布
// 预期结果：70%失败，15%H看台，15%K看台

// 模拟confirmBudget函数中的1680-2180元预算逻辑
function test1680_2180Probability(totalTests) {
  const results = {
    '抢票失败': 0,
    'H看台': 0,
    'K看台': 0
  ...
  // 输出结果
  console.log('1680-2180元预算范围概率测试结果：');
...
// 运行测试（10000次）
const percentages = test1680_2180Probability(10000);
